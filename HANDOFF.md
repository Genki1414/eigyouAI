...
**送信#4の途中経過(08:05 JST、559/959社)**: 成功10社(1.8%)・未確認2社・弾かれた194社。
前後比較: 失敗→成功10社、失敗→未確認2社。**未確認はほぼ消えた**(T126の効果。9/22は
22.8%)。未確認2件とも reCAPTCHA v3 の印は無し。goto_failed 173件は死んだドメインと
タイムアウト。母集団が「9/22に構造的に送れなかった会社」なので成功率が低いのは想定内。
